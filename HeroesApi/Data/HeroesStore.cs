...
public static class HeroesStore
{
    public static List<Hero> Heroes { get; } = new()
    {
        new Hero
        {
            ...
            PowerLevel = 75,
            Powers     = new() { "паутина", "дазание по стенам", "паучье чутье" },
        ...
        new Hero
        {
            ...
            Universe   = Universe.Marvel,
            PowerLevel = 85,
            Powers     = new() { "броня", "полет", "интелект", "лазеры" },
        ...
        new Hero
        {
            ...
            Universe   = Universe.Marvel,
            PowerLevel = 95,
            Powers     = new() { "молния", "полет", "суперсила" },
        ...
        new Hero
        {
            ...
            Universe   = Universe.Marvel,
            PowerLevel = 85,
            Powers     = new() { "регенерация", "когти", "замедленное старение" },
        ...
        new Hero
        {
            ...
            Universe   = Universe.Marvel,
            PowerLevel = 80,
            Powers     = new() { "регенераця", "владение оружием", "болтовня" },
